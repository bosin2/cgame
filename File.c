...
void guardPuzzle(int anemyDamage) {
    ...
    //가드 성공 시 피해량 없음
    if (subtraction == 0) {
        print_slow_at(15, 45, "완벽하게 막아냈다 ! o(*^▽^*)┛");
        Sleep(1000);
        clear_line();
        return;
    }
    ...
    //일부 가드시 0.5배의 피해량
        ...
        print_slow3("아쉬웠다, % 만큼의 피해를 입었다 （；´д｀）ゞ: \u30FD", 30, word, 1);
        Sleep(1000);
        clear_line();
        Health(-totalDamage);
        return;
    ...
    //가드 실패시 기존의 피해량
        ...
        print_slow3("실패했다... % 만큼의 피해를 입었다. ヽ(*。>Д<)o゜: \u30FD", 30, word1, 1);
        Sleep(1000);
        clear_line();
        Health(-totalDamage);
        return;
...
//스탯
void status() {
    print_at(40, 4, "________상 태 창________");
    print_at(40, 5, "|                      |");
    move_cursor(40, 6);
    printf("| > 소지금: %4d       |\n", totalGold);
    print_at(40, 7, "|                      |");
    ...
    move_cursor(40, 12);
    printf("| > 목숨: %4d         |\n", totalHeart);
    print_at(40, 13, "|_____________________|");
}
...
void Fight_UI3() {
    status();
    print_at(4, 3, "_______대 화 창________\n");
    print_at(4, 4, "|                     |\n");
    print_at(4, 5, "|   > 1. 인사하기     |\n");
    print_at(4, 6, "|                     |\n");
    print_at(4, 7, "|                     |\n");
...
void event9() {
    ...
    nemo();
    int choice;
    print_slow_at(3, 10, "당신은 길을 걷다 행운의 황금수뭉이 조각상을 마주쳤습니다. 소원을 빌수있을거 같습니다, 빌어볼까 ?\n");
    print_at(9, 14, "    ㅅ   ㅁ  ");
    print_at(9, 15, " ミ ・ 。・ ミ ");
    print_at(9, 16, "|—○———○—————————————————————————————————————————————|");
    print_at(12, 19, "> 1. 돈 많이 벌게 해주세요 !");
    print_slow_at(15, 21, "] 이런, 욕심많은 사람 같으니라고");
...
void bose3_fight1() {
    ...
    print_slow("드디어, 마왕이다.");
    Sleep(1000);
    print_slow_at(15, 45, "\"안녕 ? 기다렸어 지금 까지 계속... 계속.\"\n");
    Sleep(1000);
    print_at(15, 45, "                                                                   ");
    print_slow_at(15, 45, "\"자네는...음 마왕님을 무찌르러 가는길인건가 ?\"\n");
    Sleep(1000);
...
void bosses2() {
    ...
    Fight_UI2();
    nemo();
    print_at(49, 15, "く__, .ヘヽ. / , ー､ 〉                ");
    print_at(49, 16, "　　　＼ ', !-─‐-i　/　/´           ");
    print_at(49, 17, "　 　 ／｀ｰ'　　　 L/／｀ヽ､           ");
    print_at(49, 18, " 　 /　 ／,　 /|　 ,　 ,　　　 ',      ");
    print_at(49, 19, "　ｲ 　/ /-‐/　ｉ　L_ ﾊ ヽ!　 i        ");
    print_at(49, 20, "　 ﾚ ﾍ 7ｲ｀ﾄ　 ﾚ'ｧ-ﾄ､!ハ|　 |          ");
    print_at(49, 21, "　　 !,/7 '0'　　 ´0iソ| 　      |　　");
    print_at(49, 22, "　　 |.从 　　_　　 ,,,, / |./ 　 |    ");
    print_at(49, 23, "　　 ﾚ'| i＞.､,,__　_,.イ / 　.i 　|   ");
    print_at(49, 24, "　　　 ﾚ'| | / k_７_/ﾚ'ヽ,　ﾊ.　|      ");
    print_at(49, 25, "　　　　 | |/i 〈|/　 i　,.ﾍ |　i　|   ");
    print_at(49, 26, "　　　　.|/ /　ｉ： 　 ﾍ!　　＼　|     ");
    print_at(49, 27, "　 　 　 kヽ>､ﾊ 　 _,.ﾍ､ 　 /､!        ");
    print_at(49, 28, "　　　　 !'〈//｀Ｔ´', ＼ ｀'7'ｰr'    ");
    print_at(49, 29, "　　　　 ﾚ'ヽL__|___i,___,ンﾚ|ノ       ");
    print_at(49, 30, "　　　 　　　ﾄ-,/　|___./              ");
    print_at(49, 31, "　　　 　　　'ｰ'　　!_,.:              ");
...
void bosses1() {
    ...
    print_at(49, 24, "              ＿＿");
    print_at(49, 25, "　　　　　／＞　　フ");
    print_at(49, 26, "　　　　　| 　_　 _ l");
    print_at(49, 27, "　 　　　／` ミ＿xノ");
    print_at(49, 28, "　　 　 /　　　 　 |");
    print_at(49, 29, "　　　 /　 ヽ　　 ﾉ");
    print_at(49, 30, "　 　 │　　|　|　|");
    print_at(49, 31, "　／￣|　　 |　|　|");
    print_at(49, 32, "　| (￣ ヽ＿_ヽ_)__)");
    print_at(49, 33, "　＼二つ");
    move_cursor(15, 35);
    print_slow("보스, 사슬낫의 김석규가 등장했다.");
    Sleep(1000);
