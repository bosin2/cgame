...
void specials5() {
    ...
    print_slow_at(15,48," 동앗줄의 길태석이 공격합니다....!!!");
    Sleep(1000);
    print_at(15, 48, "                                   ");
    print_slow_at2(15, 48, "\"크앗 너무 강하다 !!!\"",50);
    Sleep(1000);
    print_at(15, 48, "                                         ");
    print_slow_at(15, 48, "근데 갑자기 ???? 왜지???");
    Sleep(1000);
    print_at(15, 48, "                                   ");
    print_slow_at(15, 48, "아무튼 당신은 30의 피해를 입었습니다...");
    Sleep(1000);
    print_at(15, 48, "                                        ");
    print_slow_at(15, 48, " 길태숙은 이유없이 공격하고는 날아갔습니다...");
    Sleep(1000);
    print_at(15, 48, "                                                   ");
